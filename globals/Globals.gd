...
var upgrade_descriptions = {
	...
	WEAPON_UPGRADES.SMGHOME: "INCREASES HOMING RADIUS OF BULLETS",
...
(BULLET COOLDOWN DECREASES)''',
	...
	POWERUPS.BLAST: "INCREASES HOW LONG ENEMIES ARE KNOCKED BACK FOR BY YOUR BLAST ABILITY",
